...
const extractSpecimenInfo = (message) => {
  return cleanObject({
    ...
    specimenTypeModifier: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      5
    ),
    specimenAdditives: getInformationBySegmentTypeAndIndex(message, 'SPM', 6),
    specimenCollectionMethod: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      7
    ),
    specimenSourceSite: getInformationBySegmentTypeAndIndex(message, 'SPM', 8),
    specimenSourceSiteModifier: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      9
    ),
    specimenCollectionSite: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      10
    ),
    specimenRole: getInformationBySegmentTypeAndIndex(message, 'SPM', 11),
    specimenCollectionAmount: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      12
    ),
    groupedSpecimenCount: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      13
    ),
    specimenDescription: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      14
    ),
    specimenHandlingCode: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      15
    ),
    specimenRiskCode: getInformationBySegmentTypeAndIndex(message, 'SPM', 16),
    specimenCollectionDateTime: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      17
    ),
    ...
    specimenExpirationDateTime: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      19
    ),
    specimenAvailability: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      20
    ),
    specimenRejectReason: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      21
    ),
    specimenQuality: getInformationBySegmentTypeAndIndex(message, 'SPM', 22),
    specimenAppropriateness: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      23
    ),
    specimenCondition: getInformationBySegmentTypeAndIndex(message, 'SPM', 24),
    specimenCurrentQuantity: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      25
    ),
    numberOfSpecimenContainers: getInformationBySegmentTypeAndIndex(
      message,
      'SPM',
      26
    ),
