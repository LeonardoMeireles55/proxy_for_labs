...
const extractCommonOrderInfo = (message) => {
  return cleanObject({
    ...
    dateTimeOfTransaction: getInformationBySegmentTypeAndIndex(message, 'ORC', 9),
    ...
    callBackPhoneNumber: getInformationBySegmentTypeAndIndex(message, 'ORC', 14),
    orderEffectiveDateTime: getInformationBySegmentTypeAndIndex(message, 'ORC', 15),
    orderControlCodeReason: getInformationBySegmentTypeAndIndex(message, 'ORC', 16),
    enteringOrganization: getInformationBySegmentTypeAndIndex(message, 'ORC', 17),
    ...
    advancedBeneficiaryNoticeCode: getInformationBySegmentTypeAndIndex(message, 'ORC', 20),
    orderingFacilityName: getInformationBySegmentTypeAndIndex(message, 'ORC', 21),
    orderingFacilityAddress: getInformationBySegmentTypeAndIndex(message, 'ORC', 22),
    orderingFacilityPhoneNumber: getInformationBySegmentTypeAndIndex(message, 'ORC', 23),
    orderingProviderAddress: getInformationBySegmentTypeAndIndex(message, 'ORC', 24),
    orderStatusModifier: getInformationBySegmentTypeAndIndex(message, 'ORC', 25),
    advancedBeneficiaryNoticeOverrideReason: getInformationBySegmentTypeAndIndex(message, 'ORC', 26),
    fillersExpectedAvailabilityDateTime: getInformationBySegmentTypeAndIndex(message, 'ORC', 27),
    confidentialityCode: getInformationBySegmentTypeAndIndex(message, 'ORC', 28),
    orderType: getInformationBySegmentTypeAndIndex(message, 'ORC', 29),
    entererAuthorizationMode: getInformationBySegmentTypeAndIndex(message, 'ORC', 30),
    parentUniversalServiceIdentifier: getInformationBySegmentTypeAndIndex(message, 'ORC', 31)
  });
};
