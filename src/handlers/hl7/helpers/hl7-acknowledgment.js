...
const { removeMllpFraming, parseMshSegment, parseRawHL7ToString } = require("./parser")
 ...
 */
const createAcknowledgment = (ackCode = 'AA', originalMessageControlId = 'M1926001063500000963',
    processingId = 'P', versionId = '2.5.1', triggerEvent = 'R01') => {
