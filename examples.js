const { parseRawStringToHL7Buffer, parseRawHL7ToString, extractHl7Data, HL7toJson, getInformationBySegmentTypeAndIndex } = require("./src/handlers/hl7")
...
const segment = getInformationBySegmentTypeAndIndex(rawHL7MessageBuffer, 'MSH', 5)
