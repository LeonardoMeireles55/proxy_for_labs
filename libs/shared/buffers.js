 ...
 */
const HL7_FRAMING = {
        START_BLOCK: ASCII_BUFFERS.VT,
        SEGMENT_SEPARATOR: ASCII_BUFFERS.CR,
        FILE_SEPARATOR: ASCII_BUFFERS.FS,
        END_BLOCK: ASCII_BUFFERS.FS + ASCII_BUFFERS.CR // HL7 block end: <FS><CR>
}
...
/**
* Convert control character code to actual character
* @param {number} charCode - ASCII character code
* @returns {string} The actual control character
*/
const toChar = (charCode) => String.fromCharCode(charCode)

/**
* Convert HL7 framing to actual characters
* @returns {Object} HL7 framing with actual characters
*/
const getHL7Chars = () => ({
        START_BLOCK: toChar(HL7_FRAMING.START_BLOCK),
        SEGMENT_SEPARATOR: toChar(HL7_FRAMING.SEGMENT_SEPARATOR),
        FILE_SEPARATOR: toChar(HL7_FRAMING.FILE_SEPARATOR)
})
...
const buff = String.fromCharCode(HL7_FRAMING.SEGMENT_SEPARATOR)
const buff2 = MESSAGE_STRUCTURE_AS_STRING.SEGMENT_SEPARATOR
console.log(buff)
...
module.exports = { ASCII_BUFFERS, HL7_FRAMING, ASTM_FRAMING, MESSAGE_STRUCTURE_AS_STRING, HL7_SEPARATORS, convertMessageStructureToASCII }
